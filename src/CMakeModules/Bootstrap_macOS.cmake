...
set(USE_VULKAN ON CACHE BOOL "Use Vulkan backend (required on macOS)")
...
# Note: In Boost 1.69+, system is header-only and doesn't need to be listed as a component
...
# FFmpeg
# ============================================================================
# Homebrew FFmpeg doesn't include postproc, so we specify the components we need
...
if (Vulkan_FOUND)
    ...
    message(FATAL_ERROR "Vulkan SDK not found. Please install Vulkan SDK via 'brew install vulkan-sdk' or from https://vulkan.lunarg.com/sdk/home")
endif()

# Create Vulkan::Vulkan target if it doesn't exist
...
# Create an interface library for Apple frameworks
...
ADD_DEFINITIONS (-DCASPAR_MACOS)
ADD_DEFINITIONS (-DCASPAR_USE_VULKAN)
...
IF (CMAKE_CXX_COMPILER_ID MATCHES "Clang" OR CMAKE_CXX_COMPILER_ID MATCHES "AppleClang")
    # Visibility settings for shared libraries
    ADD_COMPILE_OPTIONS (-fvisibility=hidden)
    ADD_COMPILE_OPTIONS (-fvisibility-inlines-hidden)

    # Help TBB figure out compiler support
