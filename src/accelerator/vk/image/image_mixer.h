...
/**
 * Vulkan image mixer - stub implementation for Phase 1
 *
 * This is a minimal stub that produces black frames. Real Vulkan rendering
 * will be implemented in Phase 3.
 */
class image_mixer final : public core::image_mixer
{
  public:
    image_mixer(const spl::shared_ptr<class device>& device,
                int                                  channel_id,
