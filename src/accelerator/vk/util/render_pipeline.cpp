...
// Include the compiled SPIR-V shaders
#include <vk_screen_vert_shader.h>
#include <vk_screen_frag_shader.h>
...
struct render_pipeline::impl
{
    ...
    void create_shader_modules()
    {
        ...
        vertCreateInfo.codeSize = screen_vert_shader_spv_size * sizeof(uint32_t);
        vertCreateInfo.pCode    = screen_vert_shader_spv;
        VK(vkCreateShaderModule(device_, &vertCreateInfo, nullptr, &vert_shader_module_));

        VkShaderModuleCreateInfo fragCreateInfo{};
        fragCreateInfo.sType    = VK_STRUCTURE_TYPE_SHADER_MODULE_CREATE_INFO;
        fragCreateInfo.codeSize = screen_frag_shader_spv_size * sizeof(uint32_t);
        fragCreateInfo.pCode    = screen_frag_shader_spv;
