...
{
	struct klvanc_packet_smpte_12_2_s *pkt = (klvanc_packet_smpte_12_2_s*)p;
		   ...
		   struct klvanc_packet_header_s *hdr, void **pp)
{
	...
	struct klvanc_packet_smpte_12_2_s *pkt = (klvanc_packet_smpte_12_2_s*)calloc(1, sizeof(*pkt));
	if (!pkt)
		return -ENOMEM;
